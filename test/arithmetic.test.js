...
//  add tests for substraction
    ...
    // add test for modulus
    describe('Modulus', function () {
        it('returns the remainder of 2 positive numbers', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=5&operand2=2')
                .expect(200)
                .end(function (err, res) {
        ...
        it('returns the remainder of 2 negative numbers', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=-5&operand2=-2')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: -1 });
        ...
        it('returns the remainder of a positive and negative number', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=5&operand2=-2')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: 1 });
        ...
        it('returns the remainder of a negative and positive number', function (done) {
            request.get('/arithmetic?operation=modulus&operand1=-5&operand2=2')
                .expect(200)
                .end(function (err, res) {
                    expect(res.body).to.eql({ result: -1 });
